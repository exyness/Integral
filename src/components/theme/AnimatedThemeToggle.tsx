...
export const AnimatedThemeToggle = ({
  ...
  const getClipPath = useCallback((direction: string) => {
    switch (direction) {
      case "bottom-up":
        return {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isDark
          ? "bg-[rgba(139,92,246,0.2)] text-[#8B5CF6] border-[rgba(139,92,246,0.3)] hover:bg-[rgba(139,92,246,0.3)] hover:scale-105"
          : "bg-[rgba(245,158,11,0.2)] text-[#F59E0B] border-[rgba(245,158,11,0.3)] hover:bg-[rgba(245,158,11,0.3)] hover:scale-105",
