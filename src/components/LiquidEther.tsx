...
`;
    ...
    interface ShaderPassConstructorProps {
    ...
    class ShaderPass {
      props: ShaderPassConstructorProps;
      uniforms?: Uniforms;
      ...
      constructor(props: ShaderPassConstructorProps) {
        this.props = props || {};
    ...
    class Advection extends ShaderPass {
      ...
      constructor(simProps: ShaderPassInitProps) {
        super({
          material: {
    ...
    class ExternalForce extends ShaderPass {
      ...
      initForce(simProps: ShaderPassInitProps) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      update(
        ...
        if (!this.uniforms) return;
        let fbo_in: THREE.WebGLRenderTarget | null,
          fbo_out: THREE.WebGLRenderTarget | null;
    ...
    class Poisson extends ShaderPass {
      ...
      update(args: { iterations?: number } = {}) {
        ...
        let p_in: THREE.WebGLRenderTarget | null,
          p_out: THREE.WebGLRenderTarget | null;
        const iter = iterations ?? 0;
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
