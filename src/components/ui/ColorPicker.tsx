...
const ColorPicker = ({ value = "#1C9488", onChange }: ColorPickerProps) => {
      ...
      >
        <DraggableColorCanvas
          ...
          handleChange={(partial) => {
            const newValue = { ...color, ...partial };
            const hex_formatted = hslToHex({
              h: newValue.h,
              s: newValue.s,
              l: newValue.l,
            });
            handleColorChange({ ...newValue, hex: hex_formatted });
          }}
        />
        <input
          type="range"
          ...
          onChange={(e) => {
            ...
            handleColorChange({ ...rest, hex: hex_formatted });
          }}
        />
