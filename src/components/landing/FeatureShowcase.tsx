  ...
  const showcases = [
    {
      ...
      coverImage: `src/assets/showcase/${themeFolder}/tasks/tasks-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/tasks/tasks-cover.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-kanbanboard.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-calendar.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-projects.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-kanban-projects.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-project-analytics.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-details.webp`,
        `src/assets/showcase/${themeFolder}/tasks/tasks-project-details.webp`,
      ],
    },
    {
      id: "time",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/time/time-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/time/time-cover.webp`,
        `src/assets/showcase/${themeFolder}/time/time-active.webp`,
        `src/assets/showcase/${themeFolder}/time/time-history.webp`,
      ],
    },
    {
      id: "journal",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/journal/journal-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/journal/journal-cover.webp`,
        `src/assets/showcase/${themeFolder}/journal/journal-calendar.webp`,
        `src/assets/showcase/${themeFolder}/journal/journal-projects.webp`,
        `src/assets/showcase/${themeFolder}/journal/journal-details.webp`,
        `src/assets/showcase/${themeFolder}/journal/journal-inactive-projects.webp`,
      ],
    },
    {
      id: "budget",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/budgets/budgets-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/budgets/budgets-cover.webp`,
        `src/assets/showcase/${themeFolder}/budgets/budget-analytics.webp`,
        `src/assets/showcase/${themeFolder}/budgets/budgets-ai.webp`,
        `src/assets/showcase/${themeFolder}/budgets/budgets-calendar.webp`,
        `src/assets/showcase/${themeFolder}/budgets/budgets-history.webp`,
      ],
    },
    {
      id: "notes",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/notes/notes-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/notes/notes-cover.webp`,
        `src/assets/showcase/${themeFolder}/notes/notes-details.webp`,
      ],
    },
    {
      id: "accounts",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/accounts/accounts-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/accounts/accounts-cover.webp`,
        `src/assets/showcase/${themeFolder}/accounts/accounts-activity.webp`,
        `src/assets/showcase/${themeFolder}/accounts/accounts-usage-calendar.webp`,
        `src/assets/showcase/${themeFolder}/accounts/accounts-details.webp`,
      ],
    },
    {
      id: "pomodoro",
      ...
      coverImage: `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-cover.webp`,
      galleryImages: [
        `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-cover.webp`,
        `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-focus.webp`,
        `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-short-break.webp`,
        `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-long-break.webp`,
        `src/assets/showcase/${themeFolder}/pomodoro/pomodoro-history.webp`,
      ],
    },
  ];
