      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        >
          ...
          >
            ...
            <p>We are INTEGRAL LABS LLC ('Company', 'we', 'us', or 'our').</p>
            <p>
            ...
            <p>
              Manage tasks, track time, journal your progress, control your
              budget, and organize notes—all in one beautiful, integrated
              platform.
            </p>
            <p>
            ...
            <p>
              ...
              and INTEGRAL LABS LLC, concerning your access to and use of the
            ...
            <ol className="space-y-2">
              <li>
                <a href="#services" className="text-[#8B5CF6] hover:underline">
                  OUR SERVICES
                </a>
              </li>
              <li>
                <a href="#ip" className="text-[#8B5CF6] hover:underline">
                  INTELLECTUAL PROPERTY RIGHTS
                </a>
              </li>
              <li>
                <a href="#userreps" className="text-[#8B5CF6] hover:underline">
                  USER REPRESENTATIONS
                </a>
              </li>
              <li>
                <a href="#userreg" className="text-[#8B5CF6] hover:underline">
                  USER REGISTRATION
                </a>
              </li>
              <li>
                <a href="#purchases" className="text-[#8B5CF6] hover:underline">
              ...
              <li>
                <a href="#ugc" className="text-[#8B5CF6] hover:underline">
                  USER GENERATED CONTRIBUTIONS
                </a>
              </li>
              <li>
                <a href="#license" className="text-[#8B5CF6] hover:underline">
              ...
              <li>
                <a href="#ppyes" className="text-[#8B5CF6] hover:underline">
                  PRIVACY POLICY
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#law" className="text-[#8B5CF6] hover:underline">
                  GOVERNING LAW
                </a>
              </li>
              <li>
                <a href="#disputes" className="text-[#8B5CF6] hover:underline">
                  DISPUTE RESOLUTION
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#liability" className="text-[#8B5CF6] hover:underline">
              ...
              <li>
                <a href="#userdata" className="text-[#8B5CF6] hover:underline">
                  USER DATA
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#misc" className="text-[#8B5CF6] hover:underline">
                  MISCELLANEOUS
                </a>
              </li>
              <li>
            ...
            <h2 id="services" className="text-2xl font-bold mt-8 mb-4">
              1. OUR SERVICES
            </h2>
            <p>
            ...
            <h2 id="ip" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="userreps" className="text-2xl font-bold mt-8 mb-4">
            ...
            <p>
              ...
              agree to comply with these Legal Terms; (4) you are not a minor in
            ...
            <h2 id="userreg" className="text-2xl font-bold mt-8 mb-4">
              4. USER REGISTRATION
            </h2>
            <p>
            ...
            <h2 id="purchases" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="prohibited" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="ugc" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="license" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="socialmedia" className="text-2xl font-bold mt-8 mb-4">
              9. SOCIAL MEDIA
            </h2>
            <p>
            ...
            <h2 id="thirdparty" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="sitemanage" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="ppyes" className="text-2xl font-bold mt-8 mb-4">
              12. PRIVACY POLICY
            </h2>
            <p>
              ...
              Policy:{" "}
              <a
                href="https://integral.integral.com/privacy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#8B5CF6] hover:underline"
              >
                https://integral.integral.com/privacy
              </a>
            ...
            <h2 id="terms" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="modifications" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="law" className="text-2xl font-bold mt-8 mb-4">
              15. GOVERNING LAW
            </h2>
            <p>
              ...
              the State of Wyoming, without regard to its conflict of law
              principles.
            </p>

            <h2 id="disputes" className="text-2xl font-bold mt-8 mb-4">
            ...
            <p>
              ...
              Arbitration Association (AAA) website.
            </p>
            ...
            <h2 id="corrections" className="text-2xl font-bold mt-8 mb-4">
              17. CORRECTIONS
            </h2>
            <p>
            ...
            <h2 id="disclaimer" className="text-2xl font-bold mt-8 mb-4">
              18. DISCLAIMER
            </h2>
            <p>
            ...
            <h2 id="liability" className="text-2xl font-bold mt-8 mb-4">
            ...
            <p>
              ...
              THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE TWELVE (12) MONTH
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $100.00 USD.
            </p>

            <h2 id="indemnification" className="text-2xl font-bold mt-8 mb-4">
              20. INDEMNIFICATION
            </h2>
            <p>
            ...
            <h2 id="userdata" className="text-2xl font-bold mt-8 mb-4">
              21. USER DATA
            </h2>
            <p>
            ...
            <h2 id="electronic" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="california" className="text-2xl font-bold mt-8 mb-4">
            ...
            <h2 id="misc" className="text-2xl font-bold mt-8 mb-4">
              24. MISCELLANEOUS
            </h2>
            <p>
