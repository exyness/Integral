    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        >
          ...
          >
            <p>
              This Cookie Policy explains how INTEGRAL LABS LLC ("Company,"
            ...
            <p>
              Cookies set by the website owner (in this case, DISRUPTIONS LAB
              SOLUTIONS LLC) are called "first-party cookies." Cookies set by
            ...
            <address className="not-italic ml-4">
              <strong>INTEGRAL LABS LLC</strong>
              <br />
